...
function SignupForm({ cameraRef }) {
  ...
  const startCapture = () => {
    ...
    intervalRef.current = setInterval(() => {
      if (count >= 5) {
        ...
        setStatusMessage('All 5 photos captured! Ready to signup.')
        return
      }
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setStatusMessage('✅ Signup completed successfully! You can now login.')
      setEmail('')
      setUsername('')
      setImages([])
      setCaptureCount(0)
    ...
    <div className="signup-form">
      ...
      <form onSubmit={handleSignup}>
        ...
        <div className="capture-section">
          <h3>Face Capture ({captureCount}/5)</h3>
